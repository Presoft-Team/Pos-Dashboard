...
// The classic Monthly overview, formerly app/(dashboard)/page.tsx.
//
// It moved out of the route folder when / became a redirect to the v2
// dashboard: the file could not be deleted or moved on the machine this
// was edited from, so the component was lifted here and
// app/(dashboard)/monthly/page.tsx now renders it. Nothing in the page
// itself changed.
