...
// old schema_v2.sql `sales` table. See PLAN.md §3. Cash/Credit split only —
...
credit_notes AS (
  ...
  -- cash/credit by whichever doc CN.OurInvoiceNo resolves to.
  SELECT
    cn.DocNo AS doc_no,
...
// order_date, branch_id, item_id, quantity, unit_cost, currency
